...
getDetails();
// for data rendering 
function setdetails(image, name, life, height, weight, origin, bredfor, breedgroup, temperament) {
...
DogList.addEventListener('change', async () => {
    ...
    setdetails(dog.image.url, dog.name, dog.life_span, dog.height.metric, dog.weight.metric, dog.origin, dog.bred_for, dog.breed_group, dog.temperament);
